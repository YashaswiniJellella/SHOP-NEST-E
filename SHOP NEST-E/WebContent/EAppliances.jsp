...
<body background="ov.jpg">
	...
	<%
		...
		String sql = "select * from electronics where Product='" + id
				+ "';";
	...
	<div class="w3-row">
		...
		<input type="hidden" name="db" value="electronics">
	...
	<div class="w3-text-white w3-blue"
		style="display: inline-block; width: 330px; height: 210px; margin: 18px;">
		<table>
			<tr>
				<td><table>
						<tr>
							<td>
								<%
									String s = "photo.jsp?name=" + s2 + "&&db=electronics";
								String s3 = "Product.jsp?id1="+s2+"&&db=electronics&&id="+id;
				...
				<td>
					<table class="w3-table">
						<tr>
							<td><a href=<%=s3%>><%=rs.getString(1)%></a></td>
						</tr>
						<tr>
						...
						<tr>
						 ...
						 <tr>
							<td style="text-decoration:line-through; ">(<%=rs.getInt(6)%>)</td>
						</tr>
						<%--<tr>
							<td><%=axis%>% from Axis Bank</td>
						</tr> --%>
					</table>
				</td>
			</tr>
