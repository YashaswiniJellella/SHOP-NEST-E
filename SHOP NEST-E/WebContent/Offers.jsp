...
<div class="w3-dropdown-hover">
<button class="w3-text-white w3-button w3-orange">Luggage</button>
<div class="w3-dropdown-content w3-bar-block">
<a href="LAppliances.jsp?id=backpacks" class="w3-bar-item w3-blue w3-button">Back Pack</a>
<a href="LAppliances.jsp?id=travel" class="w3-bar-item w3-blue w3-button">Traveler</a>
...
<a href="Cart.jsp" class="w3-bar-item w3-blue w3-button">Cart</a>
...
<br>
<center>
<h3 class="w3-text-white">Available Offers</h3>
<table class="w3-table w3-blue-gray" style="height: 250px; width: 450px">
