...
<form action="AdminLogin" method="get" name="form" onsubmit="return fun(this.value)">
...
<br>
<div class="w3-bar " >
<div class="w3-button w3-text-white w3-silver" ><a href="index.html" style="text-decoration: none;">Home </a></div>
</div>
<div class="w3-row " >
<div class="w3-col w3-container w3-quarter w3-white"></div>
<div class="w3-col w3-text-white w3-center w3-half">
<h2 style="font-size: 30px;"><b> Admin Login Page</b></h2>
</div>
</div>
<center>
...
<b>User Id</b></td><td>
<input type="text" class="w3-text w3-hover-aqua" name="ui"></td></tr>
<tr><td><b>Password</b></td><td>
<input type="password" class="w3-text w3-hover-aqua" name="pwd"></td></tr>
</table>
