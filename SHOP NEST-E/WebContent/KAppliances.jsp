...
<%
		...
		String sql = "select * from kitchen where Product='"+id+"';";
...
<div class="w3-row">
		...
		<input type="hidden" name="db" value="kitchen">
 ...
 <%while(rs.next()){
	 s2 = rs.getString(1);
	 String s3 = "Product.jsp?id1="+s2+"&&db=kitchen&&id="+id;
	 %>
	 <div class="w3-text-white w3-blue"
			style="display: inline-block; width: 320px; height: 210px;margin: 20px;">	 <table>
	 <tr><td><table id=t1>
	 <tr><td><%
	 String s="photo.jsp?name="+s2+"&&db=kitchen";
	 %>
	 <img src=<%=s %> height="190px" width="200px"></td></tr>
	 </table></td><td>
