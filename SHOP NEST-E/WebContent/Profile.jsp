...
<body background="ov.jpg"><div class="w3-bar w3-text-white w3-center" style="width:100%; height: 120px;">
<h2 style="font-size: 40px; font-style: italic;">SHOP NEST-E</h2>
</div>
<br>
<%
 		session = request.getSession(false);
		String sql = "select * from user where FirstName='"+session.getAttribute("user")+"';";
...
<br>
<center>
<div class="w3-container w3-blue-gray" style="width: 750px; height:350px; ">
<table class="w3-table">
<tr><td><table class="w3-table w3-bordered w3-hoverable" style="width: 450px;">
<%
try{
	while(rs.next()){
	...
	%>
	<tr><td><%=rd.getColumnName(1) %></td><td><%=rs.getString(1) %></td></tr>
	<tr><td><%=rd.getColumnName(2) %></td><td><%=rs.getString(2) %></td></tr>	
	<tr><td><%=rd.getColumnName(3) %></td><td><%=rs.getString(3) %></td></tr>
	<tr><td><%=rd.getColumnName(5) %></td><td><%=rs.getString(5) %></td></tr>
	<tr><td><%=rd.getColumnName(6) %></td><td><%=rs.getString(6) %></td></tr>
	<tr><td><%=rd.getColumnName(7) %></td><td><%=rs.getString(7) %></td></tr>	
	<tr><td><%=rd.getColumnName(8) %></td><td><%=rs.getString(8) %></td></tr>
	</table></td><td>
	<table>
	<tr><td><img src=<%=s %> height="200px" width="200px"></td></tr>
	</table>
	</td></tr>
	<% }
