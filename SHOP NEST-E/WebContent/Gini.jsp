...
<body background="ov.jpg">
	...
	<%
		...
		String sql = "select * from "+db+" where Product='"+id+"';";
...
if(gi == 7){
  while(rs.next()){
	s2 = rs.getString(1);
	String s3 = "Product.jsp?id1="+s2+"&&db="+db+"&&id="+id; 
	%>
	<div class="w3-text-white w3-blue" style="display: inline-block; width: 320px; height: 210px;margin: 20px;">
	<table>
	<tr><td><table>
	<tr><td><%
...
<%} 
  ...
  while(rs.next()){
	...
	<tr><td><%=rs.getString(3) %></td></tr>
	<tr><td><%=rs.getString(4) %></td></tr>
	<tr><td><%=(rs.getInt(6)-((rs.getInt(6)*dis)/100))%></td></tr>
	</table>
	</td></tr>
	</table>
	</div>
